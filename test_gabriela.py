...
class Tests(TestCase):
    ...
    def test_custo_existente(self):
        ...
        try:    
            conn.execute("INSERT INTO Curso_Disciplina('id_curso', 'id_disciplina') VALUES " +
                "((select id from Curso where nome = 'Curso inexistente'), (select id from Disciplina where codigo = 'ECN076'));")
            assert False
    ...
    def test_disciplina_sem_codigo(self):
        try:    
            conn.execute("INSERT INTO Disciplina('nome', 'id_departamento') VALUES " +
    ...
    def test_disciplina_sem_nome(self):
        try:    
            conn.execute("INSERT INTO Disciplina('codigo', 'id_departamento') VALUES " +
                "('DCC666','DCC')")
            assert False
        except sqlite3.IntegrityError:
            assert True   
    ...
    #verifica impossibilidade de inserir uma disciplina em um departamento inexistente
    def test_disciplina_em_dep_inexistente(self):
        try:    
            conn.execute("INSERT INTO Disciplina('codigo', 'nome', 'id_departamento') VALUES " +
                "('000000','Disciplina em departamento inexistente',(SELECT id from Departamento where nome = 'Dep inexistente'))")
            assert False
        except sqlite3.IntegrityError:
            assert True 
    ...
    def test_usuario_sem_email(self):
        try:    
            conn.execute("INSERT INTO Users ('nome', 'encrypted_password') VALUES " +
                "('Usuário Teste', '$2b$12$9wVjTgsFGMex73gvCNn.HepYrvrrSTK8hqiNJxOda4NPrrEr4HxIm');")
            assert False
        except sqlite3.IntegrityError:
            assert True 
    ...
    def test_usuario_sem_nome(self):
        try:    
            conn.execute("INSERT INTO Users ('email', 'encrypted_password') VALUES " +
                "('foo@bar.tld', '$2b$12$9wVjTgsFGMex73gvCNn.HepYrvrrSTK8hqiNJxOda4NPrrEr4HxIm');")
            assert False
        except sqlite3.IntegrityError:
            assert True 
    ...
    def test_arquivo_sem_contribuinte(self):
        try:    
            conn.execute("INSERT INTO Arquivo ('nome', 'link', 'id_disciplina', 'tipo', 'ano', 'semestre', 'professor') VALUES " +
                "('Prova 1', '0000001', (select id from Disciplina where nome = 'MATEMATICA DISCRETA' ), 'Prova', 2018, 1, 'Loureiro');")
            assert False
        except sqlite3.IntegrityError:
            assert True 
    ...
    def test_arquivo_link_repetido(self):
        try:    
            conn.execute("INSERT INTO Arquivo ('id_contribuinte', 'nome','link', 'id_disciplina', 'tipo', 'ano', 'semestre', 'professor') VALUES " +
    ...
    def test_arquivo_sem_disciplina(self):
        try:    
            conn.execute("INSERT INTO Arquivo ('id_contribuinte', 'nome', 'link', 'id_disciplina', 'tipo', 'ano', 'semestre', 'professor') VALUES " +
                "(1, 'Prova 1', '0000002', (select id from Disciplina where nome = 'DISCIPLINA INEXISTENTE' ), 'Prova', 2018, 1, 'Loureiro');")
            assert False
        except sqlite3.IntegrityError:
            assert True 
    ...
    def test_arquivo_sem_tipo(self):
        try:    
            conn.execute("INSERT INTO Arquivo ('id_contribuinte', 'nome', 'link', 'id_disciplina', 'ano', 'semestre', 'professor') VALUES " +
                "(1, 'Prova 1', '0000003', (select id from Disciplina where nome = 'MATEMATICA DISCRETA' ), 2018, 1, 'Loureiro');")
            assert False
        except sqlite3.IntegrityError:
            assert True 
